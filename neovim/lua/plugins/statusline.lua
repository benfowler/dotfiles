local colors = require("themes/norchad")
...
local user_statusline_style = require("mappings").statusline_style
local statusline_style = icon_styles[vim.g.statusline_style]

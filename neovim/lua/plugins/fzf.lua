...
return {
  {
    ...
    cmd = {
      "Files", "GFiles", "Buffers", "Colors", "Ag", "Rg", "Lines", "BLines",
      "Tags", "BTags", "Marks", "Windows", "Locate", "History", "History",
      "Snippets", "Commits", "BCommits", "Commands", "Maps", "Helptags",
      "Filetypes",
    },
    keys = {
      { maps.fzf.files, ":silent! Files<CR>", desc = "FZF Files" },
      { maps.fzf.gfiles, ":silent! GFiles<CR>", desc = "FZF GFiles" },
      { maps.fzf.history, ":silent! History<CR>", desc = "FZF History" },
      { maps.fzf.buffers, ":silent! Buffers<CR>", desc = "FZF Buffers" },
      { maps.fzf.ripgrep, ":silent! Rg<CR>", desc = "FZF RipGrep" },
    },
    config = function()
